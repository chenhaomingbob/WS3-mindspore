...
# server5_cuda111_path = Path("/home/test/media_chm/softwares/cuda-11.1")
# cu111_path = Path("/usr/local/cuda-11.1")
# cu101_path = Path("/usr/local/cuda-10.1")
# if server5_cuda111_path.exists():
#     os.environ['CUDA_HOME'] = str(server5_cuda111_path)
# elif cu111_path.exists():
#     os.environ['CUDA_HOME'] = str(cu111_path)
# else:
#     os.environ['CUDA_HOME'] = str(cu101_path)
#     if 'LD_LIBRARY_PATH' in os.environ.keys():
#         os.environ['LD_LIBRARY_PATH'] = f"{os.environ['CUDA_HOME']}/lib64" + f":{os.environ['LD_LIBRARY_PATH']}"
#     else:
...
from model.model_s3dis import RandLANet_S3DIS
...
if __name__ == "__main__":
    ...
    dirs.add_argument('--model_path', type=str, help='model saved path', required=True, default='outputs')
    ...
    dirs.add_argument('--dataset_dir', type=str, help='path of dataset', default='../dataset/S3DIS')
