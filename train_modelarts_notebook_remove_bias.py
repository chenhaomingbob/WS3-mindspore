...
# class ProfileStopAtStep(Callback):
#     def __init__(self, start_step=1, stop_step=10):
#         super(ProfileStopAtStep, self).__init__()
#         self.start_step = start_step
#         self.stop_step = stop_step
#         # Init Profiler
#         print(strftime("%Y-%m-%d %H:%M:%S", localtime()) + f"[train_modelarts_notebook_v2.py] profile init")
#         self.profiler = Profiler(output_path='./profiler_data', )
#
#     # def step_begin(self, run_context):
#     #     cb_params = run_context.original_args()
#     #     step_num = cb_params.cur_step_num
#     #     # print(f"[train_modelarts_notebook_v2.py] ProfileStopAtStep step{step_num}")
#     #     if step_num == self.start_step:
#     #         print(strftime("%Y-%m-%d %H:%M:%S", localtime()) +
#     #               f"[train_modelarts_notebook_v2.py] profile start")
#     #         self.profiler.start()
#
#     def step_end(self, run_context):
#         cb_params = run_context.original_args()
#         step_num = cb_params.cur_step_num
#         # print(f"[train_modelarts_notebook_v2.py] ProfileStopAtStep end; step {step_num}")
